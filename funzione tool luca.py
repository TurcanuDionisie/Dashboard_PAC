...
def calculate_quote(quote, numero_rate, importo_rata, giorno_del_mese, frequenza, costo_sottoscrizione, diritto_fisso_iniziale, diritto_fisso):
...
gg = calculate_quote(quota, numero_rate, importo_rata, giorno_del_mese, frequenza, costo_sottoscrizione, diritto_fisso_iniziale, diritto_fisso)
